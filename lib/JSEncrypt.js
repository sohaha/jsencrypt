...
var JSEncrypt = /** @class */ (function () {
    ...
    JSEncrypt.prototype.encryptLong = function (str) {
        var k = this.getKey();
        var maxLength = k.n.bitLength() / 8 - 11;
        try {
            var lt = "";
            var ct_1 = "";
    ...
    JSEncrypt.prototype.bytesToHex = function (bytes) {
        var hex = [];
    ...
    JSEncrypt.prototype.decryptLong = function (str) {
        var k = this.getKey();
        var maxLength = k.n.bitLength() / 8;
        try {
            var s = this.base64ToArrayBuffer(str);
            var ct = "";
            if (s.length > maxLength) {
                ...
                while (true) {
                    ...
                    var bufTmp = s.slice(0, offSet);
                    offSet = offSet + maxLength;
                    var t1 = k.decrypt(this.bytesToHex(bufTmp));
                    ct += t1;
                }
                return ct;
            }
